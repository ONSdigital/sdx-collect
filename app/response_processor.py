...
class ResponseProcessor:
    ...
    def _requires_dap_processing(self, decrypted_json):
        if self._is_feedback_survey(decrypted_json):
            ...
            return False
        if decrypted_json.get("survey_id") in ["007", "023", "134", "147", "281", "283", "lms", "census"]:
    ...
    def send_notification(self, store_response_json):
        ...
        try:
            ...
            self.notifications.publish_message(json.dumps(store_response_json), headers={'tx_id': self.tx_id})
        except PublishMessageError:
